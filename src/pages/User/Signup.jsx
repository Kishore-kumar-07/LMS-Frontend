    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 ">
      <div className="bg-white rounded-lg  flex items-center justify-center p-5 m-5 flex-col w-[627px] h-[600px] ">
        ...
        <form
          ...
          className="w-[627px] h-[484px] pl-10 pr-10"
        >
          <div className="mb-8  ">
            <label className="block text-[#333333] text-Inter">Full Name</label>
            <input
              type="string"
          ...
          <div className="mb-8  ">
            <label className="block text-[#333333] text-Inter">Username</label>
            <input
              type="string"
              className="mt-1 p-2 w-full border  text-black rounded-md border-[#8A8A8A]"
          ...
          <div className="mb-8 ">
            <label className="block text-[#333333] text-Inter ">Password</label>
            <input
              type="password"
              className="mt-1 p-2 w-full border  text-black rounded-md border-[#8A8A8A]"
              placeholder="********"
          ...
          <button className="w-full bg-[#000]   text-white py-2 rounded-md ">
            SignUp
          </button>
          <div>
