            ...
            {isDropdownOpen && (
              <div className='absolute w-96 top-12 right-0 bg-white shadow-lg rounded-lg p-4 z-50'>
                <div className='flex flex-col'>
                  <h1 className='text-xl font-bold'>{userDetails.empName || "Unknown User"}</h1>
                  <table className='text-gray-700 mt-2 w-full break-words'>
                    <tbody>
                      <tr>
                        <td className='font-semibold w-32'>Designation:</td>
                        <td className='break-words'>{userDetails.designation || "N/A"}</td>
                      </tr>
                      <tr>
                        <td className='font-semibold w-32'>Reporting Manager:</td>
                        <td className='break-words'>{userDetails.manager || "N/A"}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className='break-words'>{userDetails.function || "N/A"}</td>
                      </tr>
                      <tr>
                        <td className='font-semibold w-32'>Department:</td>
                        <td className='break-words'>{userDetails.department || "N/A"}</td>
                      </tr>
                      <tr>
                        <td className='font-semibold w-32'>Band/Level:</td>
                        <td className='break-words'>{userDetails.level || "N/A"}</td>
                      </tr>
                      <tr>
                        <td className='font-semibold w-32'>Location:</td>
                        <td className='break-words'>{userDetails.location || "N/A"}</td>
                      </tr>
                      <tr>
                        <td className='font-semibold w-32'>Unit:</td>
                        <td className='break-words'>{userDetails.unit || "N/A"}</td>
                      </tr>
                    </tbody>
                  </table>
                  <button
